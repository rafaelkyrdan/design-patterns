 ...
 * just the simple methods and the rest of the process will be performed by the structural.patterns.facade class.
 * <p>
 * Notice that, the structural.patterns.facade class has provided a simple interface to the complex subsystem,
