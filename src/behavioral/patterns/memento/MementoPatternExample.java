 ...
 * the last behavioral.patterns.state of the object which is clearly shows in the output.
 * Then we applied some operations and again saved the states of the object as “SAVE2, SAVE3, and SAVE4”.
 * Then, we asked the Originator to restore the SAVE2 behavioral.patterns.state and the call the `undoAll`
 * method which set the initial behavioral.patterns.state of the object and deleted all the save-points.
 */
