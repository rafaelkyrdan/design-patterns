...
/**
 * We have set different type of jobs, but by using the Command Design Pattern,
 * we decouple the job from the invoker thread. The thread will execute any kind of
 * object that implements the Job interface. The different behavioral.patterns.command objects encapsulate
