...
/**
 * It is another form of the Builder pattern.
 * Instead of making the desired object directly, the client calls a constructor
 * with all of the mandatory parameters and gets a creational.patterns.builder object.
 * Then the client calls setter-like methods on the creational.patterns.builder object
 * to set each optional parameters.
 * Finally, the client calls a `build` method to generate the object.
 */
public class Form {
